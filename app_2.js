...
function DRAW(app) {
    ...
    var _txt = new function () {
        ...
        function change_num(type, num) {
            switch (type) {
                case 'current_count': current_count.change_num(num); break;
                case 'request_sec': request_sec.change_num(num); break;
                case 'response_sec': response_sec.change_num(num); break;
                case 'warning': warning.change_num(num); break;
                case 'normal': normal.change_num(num); break;
                case 'alarm': alarm.change_num(num); break;
            }
        }
        this.change_num = change_num;
